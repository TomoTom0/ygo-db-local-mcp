...
export type Race = 'aqua' | 'beast' | 'beastwarrior' | 'creatorgod' | 'cyberse' | 'dinosaur' | 'divine' | 'dragon' | 'fairy' | 'fiend' | 'fish' | 'illusion' | 'insect' | 'machine' | 'plant' | 'psychic' | 'pyro' | 'reptile' | 'rock' | 'seaserpent' | 'spellcaster' | 'thunder' | 'warrior' | 'windbeast' | 'wyrm' | 'zombie';
export type MonsterType = 'normal' | 'effect' | 'fusion' | 'ritual' | 'synchro' | 'xyz' | 'link' | 'pendulum' | 'tuner' | 'spirit' | 'union' | 'gemini' | 'flip' | 'toon' | 'special';
