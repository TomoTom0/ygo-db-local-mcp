...
`);
  ...
  const categories = {
    '基本情報': ['cardType', 'name', 'nameModified', 'ruby', 'cardId', 'ciid', 'imgs', 'text'],
    'モンスターフィールド': ['attribute', 'levelType', 'levelValue', 'race', 'monsterTypes', 'atk', 'def', 'linkMarkers', 'pendulumScale', 'pendulumText', 'isExtraDeck'],
    '魔法・罠フィールド': ['spellEffectType', 'trapEffectType'],
    '補足情報': ['supplementInfo', 'supplementDate', 'pendulumSupplementInfo', 'pendulumSupplementDate']
  };
