...
server.tool(
  "search_faq",
  `Search Yu-Gi-Oh! FAQ database by FAQ ID, card ID, question text, or answer text. Returns FAQs with embedded card information for all cards mentioned in the Q&A.`,
  {
